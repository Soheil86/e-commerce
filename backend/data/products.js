const products = [
  {
    ...
    tags: ['nvidia', 'graphics card', 'gaming'],
    available: true,
  ...
  },
  {
    ...
    tags: ['logitech', 'mouse', 'wireless', 'bluetooth'],
    available: true,
    is_best_seller: true,
    price: {
      currency: 'EURO',
  ...
  },
  {
    ...
    brand: 'Apple',
    category: 'Laptop',
    tags: ['laptop', 'apple', '13 inch', 'm1', 'gray'],
    available: false,
    is_best_seller: true,
    price: {
      currency: 'EURO',
  ...
  },
  {
    ...
    tags: ['hp', 'ink', 'printers', 'overpriced', 'tinten'],
    available: true,
    is_best_seller: false,
    price: {
      currency: 'EURO',
  ...
  },
  {
    ...
    brand: 'Apple',
    category: 'Smartphone',
    tags: ['apple', 'iphone', '128', 'smartphone', 'phone'],
    available: true,
    is_best_seller: true,
    price: {
      currency: 'EURO',
  ...
  },
  {
    ...
    brand: 'Nintendo',
    category: 'Gaming',
    tags: ['nintendo', 'switch', 'joycon', 'portable', 'gaming'],
    available: false,
    is_best_seller: false,
    price: {
      currency: 'EURO',
  ...
  },
  {
    ...
    tags: ['usb', 'type c', 'stick', 'sandisk', '128'],
    available: true,
    is_best_seller: false,
    price: {
      currency: 'EURO',
